...
class ResourceRegistry
     ...
     * * Resources that implement `Closeable` will be closed when (or if) the registry is closed.
     *
     * @param resource  the named resource to register
     * @param behavior  the `RegistrationBehavior` to use
     * @param observer  an optional `Observer` that will be called when the resource is being closed
     *
     * @return  `True` iff the resource was registered, or `False` if registration failed
     ...
     *          if the specified `RegistrationBehavior` is `Always`.
     */
    <RegisterAs, Resource extends RegisterAs> conditional String register(NamedResource<RegisterAs, Resource> resource,
            RegistrationBehavior behavior = RegistrationBehavior.Fail,
            Observer<Resource>? observer = Null) {

        ResourceHolder<RegisterAs, Resource> holder = new ResourceHolder(resource.type, resource.resource, resource.name, behavior, observer);
     ...
     * * Resources that implement `Closeable` will be closed when (or if) the registry is closed.
     *
     * @param resource  the `ResourceHolder` wrapper containing the resource to register
     *
     * @return  `True` iff the resource was registered, or `False` if registration failed
     * @return  the name used to register the resource, which may be different from the name parameter
     *          if the specified `RegistrationBehavior` is `Always`.
     */
    conditional String register(ResourceHolder resource) {
     ...
     */
    static <ResourceType> ResourceHolder<ResourceType, ResourceType> resource(
        ...
        return new ResourceHolder(type, resource, name, behavior, observer);
    }
     ...
     */
    static class ResourceHolder<RegisterAs, ResourceType extends RegisterAs>(
