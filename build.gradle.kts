...
//    to run this first as a saftety measure. To actually perform the deletions, use the task
//    "gitCleanLive" instead.
...
//   with the exception of individual IDE configurations.
//
//   Use with caution, and to be safe, it is recommended that you run the task 'gitClean' first,
//   to get a list of the files and directories that will be purged.
